...
var CONFIG = {
  ...
  produit: {
    ...
    prix_barre: "7 450 DA",
    remise:     "−16%",
    stock:      8   // chiffre affiché dans la bannière urgence
  },

  /* ── CONTACT ── */
  contact: {
    whatsapp: "213557190401",   // format international sans + ni 00
    telephone: "0796960426"     // format local pour le bouton Appeler
  },
  ...
  /* ── COULEURS + PHOTOS + POINTURES ──
     Pour chaque couleur :
       nom       = nom affiché sur le bouton
       hex       = couleur du bouton (code couleur)
       photos    = URLs Shopify CDN de cette couleur
       pointures = disponibles et épuisées pour cette couleur

     Pour épuiser une pointure → déplace de disponibles vers epuisees
     Pour restocquer          → déplace de epuisees vers disponibles
     Pour ajouter une couleur → copie un bloc {..} et adapte
  ── */
  couleurs: [
    {
      nom:    "Marron",
    ...
    /* Pour ajouter une couleur, copie ce bloc :
    ,{
      nom:    "Beige",
      hex:    "#D4B896",
      photos: [
        "https://cdn.shopify.com/s/files/COLLE-URL-BEIGE-1.jpg"
      ],
      pointures: {
        disponibles: ["36", "37", "38", "39", "40", "41"],
        epuisees:    []
  ...
  /* ── AVIS CLIENTS WHATSAPP ──
     URLs des captures WhatsApp uploadées sur Shopify CDN
     Pour ajouter un avis : ajoute une ligne entre guillemets
  ── */
  avis_photos: [
    ...
    /* Pour ajouter un avis : ajoute une virgule après la dernière ligne
       puis colle l'URL entre guillemets */
  ]
